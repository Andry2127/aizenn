...
position_blueprint = Blueprint("position", __name__, url_prefix="/positions/")
...
def app_position():
    with Session() as session:
        ...
        return render_template("position/management.html", positions=positions, title="Position list management")
